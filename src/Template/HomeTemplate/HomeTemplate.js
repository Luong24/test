            ...
            <Layout style={{ minHeight: '100vh' }} >
                <Sider className='border-r' style={{ backgroundColor: '#e4eaf2' }} collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
                    ...
                    <Menu defaultSelectedKeys={['1']} mode="inline" style={{ backgroundColor: 'transparent' }}>
                        <Menu.Item key='1'>
                            <NavLink className='flex items-center text-base text-black nav-link focus:font-bold' to='/home' ><AiOutlineHome className='mr-2' /> Trang chủ</NavLink>
                        </Menu.Item>
                        <Menu.Item key='2' >
                            <NavLink className='flex items-center text-base text-black nav-link focus:font-bold' to='/schedule' ><AiOutlineSchedule className='mr-2' />Lịch cơ quan</NavLink>
                        </Menu.Item>
                        <Menu.Item key='3' >
